...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // external
      // proto
      char dummy3[sizeof (PrototypeAST*)];

      // program
      // top
      char dummy4[sizeof (RootAST*)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_startsymb = 39,                        // startsymb
        S_program = 40,                          // program
        S_top = 41,                              // top
        S_definition = 42,                       // definition
        S_external = 43,                         // external
        S_proto = 44,                            // proto
        S_idseq = 45,                            // idseq
        S_exp = 46,                              // exp
        S_idexp = 47,                            // idexp
        S_optexp = 48,                           // optexp
        S_explist = 49,                          // explist
        S_ifexp = 50,                            // ifexp
        S_forexp = 51,                           // forexp
        S_step = 52,                             // step
        S_whilexp = 53,                          // whilexp
        S_varexp = 54,                           // varexp
        S_varlist = 55,                          // varlist
        S_pair = 56,                             // pair
        S_assignment = 57,                       // assignment
        S_arraydef = 58,                         // arraydef
        S_arrayexp = 59                          // arrayexp
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::TOK_END
                   || (token::TOK_YYerror <= tok && tok <= token::TOK_ARROF));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOK_FUN, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_ARROF (location_type l)
      {
        return symbol_type (token::TOK_ARROF, std::move (l));
      }
#else
      static
      symbol_type
      make_ARROF (const location_type& l)
      {
        return symbol_type (token::TOK_ARROF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
