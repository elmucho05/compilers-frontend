...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // binding
      char dummy2[sizeof (BindingAST*)];

      // block
      char dummy3[sizeof (BlockAST*)];
      ...
      // relexp
      // idexp
      char dummy4[sizeof (ExprAST*)];

      // forstmt
      char dummy5[sizeof (ForStmtAST*)];

      // definition
      char dummy6[sizeof (FunctionAST*)];

      // globalvar
      char dummy7[sizeof (GlobalVarAST*)];

      // ifstmt
      char dummy8[sizeof (IfStmtAST*)];

      // init
      char dummy9[sizeof (InitAST*)];

      // external
      // proto
      char dummy10[sizeof (PrototypeAST*)];

      // program
      // top
      char dummy11[sizeof (RootAST*)];

      // stmt
      char dummy12[sizeof (StmtAST*)];
      ...
      // vardefs
      char dummy15[sizeof (std::vector<BindingAST*>)];

      // optexp
      // explist
      char dummy16[sizeof (std::vector<ExprAST*>)];

      // stmts
      char dummy17[sizeof (std::vector<StmtAST*>)];
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_globalvar: // globalvar
        value.move< GlobalVarAST* > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_vardefs: // vardefs
        value.move< std::vector<BindingAST*> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, GlobalVarAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const GlobalVarAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<BindingAST*>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<BindingAST*>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_globalvar: // globalvar
        value.template destroy< GlobalVarAST* > ();
        break;
      ...
      case symbol_kind::S_vardefs: // vardefs
        value.template destroy< std::vector<BindingAST*> > ();
        break;
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_LSQBRACE (const location_type& l)
      {
      ...
      static
      symbol_type
      make_RSQBRACE (const location_type& l)
      {
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_globalvar: // globalvar
        value.copy< GlobalVarAST* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_vardefs: // vardefs
        value.copy< std::vector<BindingAST*> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_globalvar: // globalvar
        value.move< GlobalVarAST* > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_vardefs: // vardefs
        value.move< std::vector<BindingAST*> > (YY_MOVE (s.value));
        break;
