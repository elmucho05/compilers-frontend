...
condstmt:                                         ; preds = %entry
  ...
  br i1 %lttest, label %true, label %merge

merge:                                            ; preds = %loopstmt, %false, %true, %condstmt
  %logictmp = phi i1 [ %lttest12, %true ], [ false, %false ]
  %nottmp = xor i1 %logictmp, true
  br i1 %nottmp, label %loopstmt, label %mergestmt
